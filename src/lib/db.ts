...
export function ensureDbReady(): Promise<void> {
  ...
  // Independent Vercel deploys have no writable FS for PGLite WASM.
  // Quiz data lives in the browser; skip embedded DB unless DATABASE_URL is set.
...
const skipEmbeddedOnVercel =
  typeof process !== "undefined" && Boolean(process.env.VERCEL) && !databaseUrl;
if (typeof window === "undefined" && dbSource === "pglite" && !skipEmbeddedOnVercel) {
