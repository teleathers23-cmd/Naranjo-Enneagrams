...
export const INSTINCTS: {
...
}[] = [
  {
    ...
    name: "自我保存",
    nameEs: "Conservación",
    brief: "指向生存、身体、领地、资源与日常稳定。注意落在「能否维持下去」。",
  },
  {
    id: "so",
    name: "社交",
    nameEs: "Social",
    brief: "指向群体中的位置、归属、适应与声誉。注意落在「我在结构里是谁」。",
  },
  {
    id: "sx",
    name: "性",
    nameEs: "Sexual",
    brief: "指向一对一的强度、吸引、选择与传递。注意落在「那一个人」而非群体或生存。",
  },
];
...
export const TYPES: {
...
}[] = [
  {
    ...
    center: "gut",
    name: "怨恨",
    brief: "情欲是愤怒：对不完美现实的持续抗议。怒很少直接爆发，而固着为怨恨与「应该」。",
    neurosis:
  ...
  },
  {
    ...
    center: "heart",
    name: "谄媚",
    brief: "情欲是骄傲：否认自身需要，同时膨胀为「被爱、被需要、享有特权的人」。不是助人性格。",
    neurosis:
  ...
  },
  {
    ...
    center: "heart",
    name: "虚荣",
    brief: "情欲是虚荣：以形象与成果代替存在。自我欺骗（mentira）使感受从属于表演。",
    neurosis:
  ...
  },
  {
    ...
    center: "heart",
    name: "忧郁",
    brief: "情欲是嫉妒：认定别人拥有自己所缺的本质、爱或位置。以匮乏与特殊维持自体。",
    neurosis:
  ...
  },
  {
    ...
    center: "head",
    name: "吝啬",
    brief: "情欲是贪婪：吝啬的是自己——时间、精力、情感与参与。害怕被耗尽而退回观察。",
    neurosis:
  ...
  },
  {
    ...
    center: "head",
    name: "怯懦",
    brief: "情欲是恐惧：把世界扫描为威胁。固着在怯懦与指控之间摆动，权威既被需要也被怀疑。",
    neurosis:
  ...
  },
  {
    ...
    center: "head",
    name: "计划",
    brief: "情欲是贪食：对经验、可能与未来的不满足。用计划与合理化逃避限制和痛苦。",
    neurosis:
  ...
  },
  {
    ...
    center: "gut",
    name: "报复",
    brief: "情欲是情欲／过量（lujuria）：要更多强度、更多生命。否认软弱，固着为报复。",
    neurosis:
  ...
  },
  {
    ...
    center: "gut",
    name: "懒散",
    brief: "情欲是怠惰：麻醉的是内在生活与意志，不是手脚是否忙碌。自我被合并或推迟。",
    neurosis:
...
export const SUBTYPES: Subtype[] = [
  ...
  },
  {
    ...
    countertype: false,
    oneLiner: "愤怒指向公共秩序。僵硬、不随俗，要求世界符合原则。",
    portrait:
      "社交一号的专名是「不适应」（inadaptabilidad）。愤怒对象是集体中的不公、马虎与虚伪。主体以原则自居，拒绝为归属而妥协。纳兰霍强调的是僵硬：不是无能，是不肯弯。他们要求被承认为正确，而非被喜欢。怨恨来自「我已做对，你们仍不改」。",
    neurosis:
      "神经症状态是道德化的攻击与社会性怨恨：好为人师、弹劾、无法忍受潜规则。对群体的适应本身被体验为堕落。怒以改革、谴责、孤立的方式维持优越的正确。常伴随对他人缺陷的持续记账。",
    markers: [
      "在群体中坚持程序与公正，难以随俗",
      "对虚伪、捷径和「大家都这样」过敏",
      "改革与谴责先于归属，僵硬被体验为忠诚于原则",
    ],
  ...
  },
  {
    ...
    nameEn: "Zeal",
    countertype: false,
    oneLiner: "愤怒有了亲密对象。热忱与嫉妒：要把那一个人改造成正确。",
    portrait:
      "性一号是热忱（zelo）与嫉妒（celos）。怒集中于理想化的他者：伴侣、同志、共同事业。主体以激情改革对方，不能容忍分心、不忠、不认真。正确成为爱的条件。妒不是单纯占有，而是「热忱被给错了地方」。外表比其他一号更强、更有性的热度，也更控制。",
    neurosis:
      "神经症状态是对被爱对象的道德化控制、妒与义愤的融合、以及「为你好」的攻击。对方的独立被体验为堕落。关系中充满纠正、理想化与贬低的循环。怒有了出口，但出口是改造人，不是承认自己的怒。",
    markers: [
      "完美标准加诸亲密对象，难以放过",
      "热情、妒意与道德义愤同时出现",
      "比其他一号更有火气，改革指向那一个人",
  ...
  },
  {
    ...
    nameEn: "Seduction",
    countertype: false,
    oneLiner: "骄傲表现为征服：成为对方的欲望对象。诱惑是攻击，不是体贴。",
    portrait:
      "性二号的专名是「诱惑」（seducción）。纳兰霍强调侵略性：诱惑是打猎。骄傲体现在「我能让你离不开我」。主体读取对方的匮乏并填入自己，给予高度个人化并带有所有权。关系降温时，骄傲以责备与纠缠受伤。不是教科书里的温柔助人者，而是一对一的情感—性占领。",
    neurosis:
      "神经症状态是性化与情感化的操控、不能忍受不被欲望、以及付出后的隐性债务。被当作「只是朋友」或可替代，会刺伤骄傲并转为追讨。需要被否认，索取通过成为不可缺的对象来完成。占有与被迫害感（「我为你做了这么多」）同属骄傲。",
    markers: [
      "一对一关系中强烈，旨在成为对方的答案",
      "需要被欲望；不被选中即骄傲受伤",
      "给予带有独占与事后追讨",
  ...
  },
  {
    ...
    nameEn: "Charisma",
    countertype: false,
    oneLiner: "虚荣落在性别魅力：成为可欲的那一个。失败是不可欲。",
    portrait:
      "性三号的虚荣是男性气概／女性气质（masculinidad/feminidad）。形象的核心是性与魅力竞争力，而非单纯业绩。纳兰霍指出表演深入身体：姿态、性感、胜利者的呈现。事业服务于「在那个人眼前发光」。被看扁、被当成无能或无吸引力，比道德指责更伤。",
    neurosis:
      "神经症状态是把自体等同于是否被选中、是否有性竞争力。失败、衰老、被无视会体验为存在取消。魅力是被管理的，不是自发的。看起来可像八号或二号，驱动仍是虚荣：我是那个男人／那个女人。",
    markers: [
      "在意性与魅力上的竞争力",
      "成就用于增加可欲性，多于单纯地位",
      "被当成无能或不可欲，比被道德批评更伤",
  ...
  },
  {
    ...
    nameEn: "Competition",
    countertype: false,
    oneLiner: "嫉妒转为恨与竞争：你有的我必须更好，否则摧毁或离开。",
    portrait:
      "性四号是竞争（competitividad），亦称恨。对象是重要他者：你拥有的，我必须胜过。纳兰霍强调攻击性——最像八号的四号，燃料却是匮乏。不能成为最被爱的那个，就攻击或切断。羡慕是热的。特殊感通过征服与被征服证明。",
    neurosis:
      "神经症状态是关系中的较量、爱恨速转、对第二位的不能忍受。平淡被体验为取消。把亲密变成戏剧以确认自己还存在。摧毁所爱（若不能独占其优越位置）是嫉妒的主动形式，不是情欲的过量。",
    markers: [
      "亲密中强烈比较，不能被放第二",
      "恨与爱迅速互换，对象总是那一个人",
      "需要张力来维持自体感；平淡不可忍",
  ...
  },
  {
    ...
    nameEn: "Confidence",
    countertype: true,
    oneLiner: "反型。对众人吝啬，对一个灵魂交出钥匙。背叛则封死。",
    portrait:
      "性五号是「信赖」（confianza），反型。仍吝啬于世界，却寻求与一人彻底交换。关系被理想化、精神化，亦可色情化。信任一旦成立，冷可转为高强度告白。被辜负则长期封闭，比发怒更彻底。看起来可像四号，驱动仍是：内在不能洒给众人。",
    neurosis:
      "神经症状态是把一个人做成唯一出口、理想化与突然的彻底切断。多数人面前的贫乏与少数人面前的过密并存。依赖被限制在秘密通道里，因而通道破裂等于世界崩塌。仍是贪婪：扣留对所有人，一次性透支给一个。",
    markers: [
      "对「那一个懂我的人」近乎绝对投注",
      "对众人封闭，对少数人可以过密",
      "被辜负后封死通道，比发作更彻底",
  ...
  },
  {
    ...
    nameEn: "Warmth",
    countertype: true,
    oneLiner: "反型。恐惧寻求庇护：用亲和与联盟换安全。看起来不像怕。",
    portrait:
      "自我保存六号是「温暖」（calor），反型。恐惧求的是庇护——可靠的人、可预测的照顾、家庭式圈子。发展出亲和、幽默、忠诚，使自己被纳入安全圈。焦虑被温暖盖住。内里仍在确认：这人会不会丢下我。对权威的反抗常表现为改投另一个权威。",
    neurosis:
  ...
  },
  {
    ...
    nameEn: "Strength",
    countertype: false,
    oneLiner: "恐惧翻转为反恐惧：先武装、先威吓，以免被占。",
    portrait:
      "性六号是强壮与威吓（fuerza / intimidación）。恐惧变成对抗：使自己危险、坚定、无法被欺。纳兰霍描述反恐惧运动——冲向威胁，选择强的对象或姿态。外表常被判为八号。内里是：若不先占领强度，强度就会来占领我。忠诚与怀疑都绝对。",
    neurosis:
      "神经症状态是先发制人、对威胁的过度读取、以及用攻击性覆盖怕。亲密中考验对方是否够强。美、锋利、叛逆可作为武装。被控、被吓是核心恐惧；反恐惧症使其看起来不像六号。",
    markers: [
      "以力量、锋利或攻击性预防被控制",
      "威胁出现时倾向迎上，而非停留在怕中",
      "亲密中需要能扛事的同盟，并考验其强度",
  ...
  },
  {
    ...
    nameEn: "Keepers",
    countertype: true,
    oneLiner: "反型。贪食落实为机会、网络与具体好处。务实，不像飘在幻想里。",
    portrait:
      "自我保存七号是「守家人／机会网络」（conservadores）。贪食落地为积累：人脉、项目、享受的基础设施、有退路的好生活。务实、会谈、找捷径。反型在于不像幻想型七号，而像享乐的安排者。痛苦仍被绕开，工具是交易与安排，不是下一场兴奋本身。",
    neurosis:
  ...
  },
  {
    ...
    nameEn: "Sacrifice",
    countertype: false,
    oneLiner: "贪食披上理想：为更大计划推迟眼前的甜。牺牲仍是逃避限度。",
    portrait:
      "社交七号是「牺牲」（sacrificio）。贪食采取理想主义形式：可以放弃眼前享乐，服务于更大计划、团体或人类。纳兰霍指出这仍是七号——牺牲是另一种计划，痛苦被升华为意义，限制被说成自愿。理想破灭则反弹为玩世或不甘。驱动是逃避平凡的痛，不是一号的原则或二号的骄傲。",
    neurosis:
      "神经症状态是以愿景逃避沉闷与悲伤、把不自由说成高尚、以及对无出口痛苦的不能忍受。慷慨与倡议维持「我是自由而有意义的」。一旦理想塌陷，贪食失去掩护。看起来可像二号、一号或九号。",
    markers: [
      "用理想和「为了大家」组织自己的活动",
      "沉闷的义务只有通向更大愿景才可忍",
      "难留在没有出口、不能被讲成意义的痛苦里",
  ...
  },
  {
    ...
    nameEn: "Fascination",
    countertype: false,
    oneLiner: "贪食对着强度本身：易感、着迷、要被下一种经验勾走。",
    portrait:
      "性七号是迷恋与易感（sugestionabilidad）。贪食指向人、冒险、幻想、边缘体验。易被点燃，也易转向。纳兰霍强调暗示性：世界是可上瘾的刺激序列。限制、重复、悲伤被迅速镀金或逃离。不是精于算计的享乐，是被可能性拐走。",
    neurosis:
      "神经症状态是对正在发生的不适的立即逃离、承诺随兴致作废、以及用讲述和下一次覆盖现在。平淡被体验为死。易感使其显得深，结构上却是贪食：不能停在一个对象或一种感情里把痛喝完。",
    markers: [
      "对人与体验迅速着迷，也迅速冷却",
      "不能忍受平淡，需要刺激维持存在感",
      "用计划、讲述和下一次躲开当前不适",
  ...
  },
  {
    ...
    nameEn: "Possession",
    countertype: false,
    oneLiner: "情欲集中于那一个人：占有与投降的双面。平淡等于没有发生。",
    portrait:
      "性八号是「占有」（posesión）。过量指向亲密对象：你是我的，关系必须有穿透力。纳兰霍谈投降与占有并存——高强度的性、冲突、忠诚与控制。不能容忍若即若离。反叛常为打破虚伪文雅。燃料是过量的生命力，不是四号的缺或二号的骄傲膨胀。",
    neurosis:
      "神经症状态是控制与融合的交织、对暧昧的爆破、以及对软弱的蔑视。占有对方也要求被同样强度地要。若即若离被体验为羞辱。犬儒与烈度维持「这是真的」。看起来可像性四、性二、性六。",
    markers: [
      "亲密必须强烈；平淡被判为未发生",
      "占有与献身纠缠：要你，也把自己交出去",
      "轻蔑虚伪与懦弱；尊重敢顶回来的人",
  ...
  },
  {
    ...
    nameEn: "Fusion",
    countertype: false,
    oneLiner: "怠惰通过与他者合并实现。理想化结合，自己的意志变薄。",
    portrait:
      "性九号是「融合」（fusión）。怠惰经合并完成：我的欲即你的欲。理想化伴侣或精神性的合一。现实摩擦被最小化，或突然变成硬墙。分离像自我被撕开。怒很少直接。看起来像二号或四号，驱动不是骄傲或嫉妒，而是不愿单独成为有意志的人。",
    neurosis:
      "神经症状态是边界消失、一人时不能发动、以及把结合理想化到否认冲突。被动攻击与突然切断是被推迟的怒。需要那个人来感觉完整，同时怨恨自己的消失。融合是麻醉，不是情欲的占有或骄傲的诱惑。",
    markers: [
      "亲密中失去自身偏好与时间",
      "理想化结合；摩擦被抹平或突然变成墙",
      "一个人难以发动；两个人时才感觉完整",
