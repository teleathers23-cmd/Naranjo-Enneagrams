...
export const INSTINCTS: {
  ...
  },
  {
    ...
    name: "性",
    nameEs: "Sexual",
    brief: "指向一对一的强度、吸引、选择与传递。焦点是单一的：一个人、一件事或一个物，不限于情爱。",
  },
];
...
export const SUBTYPES: Subtype[] = [
  ...
  },
  {
    ...
    neurosis:
      "神经症状态是先发制人、对威胁的过度读取、以及用攻击性覆盖怕。在一对一的同盟或对手关系里考验对方是否够强。美、锋利、叛逆可作为武装。被控、被吓是核心恐惧；反恐惧症使其看起来不像六号。对象不限于情人，可以是选定的搭档、敌人或事业上的对打者。",
    markers: [
      "以力量、锋利或攻击性预防被控制",
      "威胁出现时倾向迎上，而非停留在怕中",
