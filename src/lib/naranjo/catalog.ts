...
export const TYPES: {
  ...
  },
  {
    ...
    neurosis:
      "二号的神经症核心是情欲「骄傲」（Orgullo），固着是「谄媚」（Adulación / Lisonja）。骄傲意味着不承认匮乏：我没有需要，我是那个给予、被选中或应被优待的人。需要一旦出现，便以操控情感、责备、撒娇或特权要求的方式索取，并继续否认「我在要」。纳兰霍将其与歇斯底里性格联系起来：情感表演、诱惑、自恋受伤。流行九型中的「助人者」形象是误读——给予、可爱、野心皆是骄傲的策略，而非利他。\n\n美德是「谦卑」（Humility）：看见自己的需要而不膨胀。",
  },
  {
    id: 3,
    passion: "虚荣",
    ...
    neurosis:
      "三号的神经症核心是情欲「虚荣」（Vanidad），并与自我欺骗（Mentira）相连。主体认同被看见的自我，用做事、效率与成功维持自体感。感受、失败、无观众的存在被当作无价值而切断。神经症状态是自我异化：不知道自己是谁，只知道自己「看起来是谁」。停工、出丑、不被认可会触发羞耻与空洞，而非单纯挫折。\n\n美德是「诚实」（Honesty）：停止为形象而活。",
  },
  {
    id: 4,
    passion: "嫉妒",
    ...
    neurosis:
      "四号的神经症核心是情欲「嫉妒」（Envidia），固着是「忧郁」（Melancolía）。嫉妒不是偶尔羡慕，而是结构性的匮乏感：好的东西在别人那里，自己被放逐在缺失里。主体用痛苦、比较、被弃感来证明自己的深度，从而把不满变成身份。神经症状态包括自我贬低与自我特殊化的交替、对平淡的不耐受、以及把关系变成「谁更被爱」的较量。\n\n美德是「平静」（Equanimity）：不再靠缺失来存在。",
  },
  {
    id: 5,
    passion: "贪婪",
    ...
    neurosis:
      "五号的神经症核心是情欲「贪婪」（Avaricia），固着是「吝啬」（Retención）。纳兰霍强调：贪婪在此不是贪得无厌地占有，而是扣留。主体把自我当作有限库存，参与、依赖、情感支出被体验为流失。神经症状态是退缩、情感隔离、用认知替代接触，以及在关系中的计时与记账。与分裂样防卫相关。\n\n美德是「超脱」（Detachment）：不再因害怕被吸干而拒绝生命。",
  },
  {
    id: 6,
    passion: "恐惧",
...
export const SUBTYPES: Subtype[] = [
  ...
  },
  {
    ...
    name: "热忱",
    nameEs: "Zelo / Celos",
    nameEn: "Zeal / Vehemence",
    aka: "激烈（Vehemencia）",
    countertype: false,
    oneLiner: "愤怒有了一对一的焦点。热忱与嫉妒：要把认定的那一个人、事或物改造成正确。",
    portrait:
      "纳兰霍将性一号命名为「热忱」（zelo / celo），并兼用「激烈」（vehemencia）描述之。伊查佐所用的「celo」一词具有双重含义：既指动物发情时的强烈兴奋与寻求，也指以热忱、专注与狂热投入某事。在此亚型中，愤怒获得一对一的焦点，转化为对选定对象（可以是人、事业或作品）的强烈改造冲动。热忱与嫉妒并存：要把认定的那一个焦点改造成正确。",
    childhood:
      "根据纳兰霍原著及相关观察，性一号常在早期即表现出对欲望的强烈与「我有权」的态度。家庭环境中对冲动或自发性的压抑，并未完全熄灭其强度，反而使愤怒与欲望结合，形成早期的征服与纠正姿态。主体往往过早将正确性与强烈投入绑定，无法容忍分心或不认真；愤怒作为对限制的反应，因获得一对一出口而更易直接呈现，却仍被道德化包装。",
    neurosis:
      "在性本能领域，神经症状态表现为对选定对象的道德化控制、妒意与义愤的融合，以及「为你好／为它好」的攻击。对象的独立或转向被体验为堕落。一对一关系——无论对人还是对事——充满纠正、理想化与贬低的循环。怒有了出口，但出口是改造这个焦点，而非承认自身的怒。\n\n纳兰霍指出：愤怒强化了欲望，使其具有攻击性；主体不仅被强烈牵引，更感到自己有权利获得满足。结果是强烈的支配与征服精神。外表比其他一号更强、更有热度，也更控制。",
    markers: [
      "完美标准加诸一对一的单一对象（人、事或物），难以放过。",
      "热情、妒意与道德义愤同时出现。",
      "比其他一号更有火气，改革明确指向这个被选定的焦点。",
      "「热忱」既是投入的狂热，也是嫉妒的占有：不能容忍热忱被给错地方。",
    ],
    lookalikes: ["8sx", "4sx", "6sx"],
    naranjoKey: "Zelo / celos / vehemencia of the sexual One",
  },
  {
    id: "2sp",
    type: 2,
    ...
    portrait:
      "纳兰霍将自我保存二号明确命名为「特权」（privilegio），并标示为反型。在此亚型中，骄傲不表现为博爱式的给予，而表现为幼儿与一般的权利要求：我特殊，所以规则应该对我宽松；我可爱，所以你应该来照顾。他们需要以撒娇、示弱、占据资源的方式被满足，同时否认「我在要」。外表常像被宠坏或任性，而非典型的给予者。若发生给予，也多投资于能供养或优待自己的人。",
    childhood:
      "根据纳兰霍原著及相关观察，自我保存二号常在早期即成为父母（尤其是某一位）的「宠儿」或「任性对象」，以孩子的姿态持续寻求长辈的特殊优待。家庭动态使主体学会以可爱、可怜或特殊身份换取照顾与例外，而非通过成就或成人责任获得认可。结果是，主体长期停留在「被选中的孩子」位置，将存在本身视为应被优先满足的理由，而回避真正的自立。",
    neurosis:
      "在自我保存领域，神经症状态表现为自恋性特权、被忽略时的委屈与暴怒、以及对依赖的否认。主体不把自己体验为有需要的成人，而体验为应被优先满足的孩子。愤怒在得不到优待时出现，并迅速被重新包装成「你不爱我」。此亚型的骄傲以「我最重要／我应被照顾」的幼儿式重要性呈现。",
    markers: [
      "以可爱、可怜或特殊换取照顾与例外。",
      "对谁应满足自己高度敏感；被忽略即自恋受伤。",
  ...
  },
  {
    ...
    portrait:
      "纳兰霍将社交二号命名为「野心」（ambición）。在此亚型中，骄傲在群体中膨胀为影响力与重要性：成为不可缺少的人。通过组织、引荐、情感劳动使他人依赖自己，从而居于其上。策略性自我扩张。抗拒无足轻重。",
    childhood:
      "根据纳兰霍原著及相关观察，社交二号常在早期感到缺乏稳固的父母认同或安全归属，成为「无人认领的孩子」。为弥补这一空缺，主体过早追求成为「被选中」或「重要」的人，以领导、连接或情感枢纽的角色换取公众认可。野心由此成形：他们需要被群体承认为卓越、有影响力的存在。",
    neurosis:
      "在社交领域，神经症状态表现为对地位的饥渴、对边缘化的不能忍受、以及把关系工具化为晋升。给予带有账单。接近或成为重要人物、控制信息与人情，维持「没有我就不转」。社交二号以征服公众为满足，需要成为「某人」——有领导气质、有区别的群体诱惑者。",
    markers: [
      "在组织里占据显要的连接或情感枢纽。",
      "对地位、人脉和「谁重要」高度定向。",
      "被边缘化比被道德批评更难忍。",
  ...
  },
  {
    ...
    instinct: "sx",
    name: "诱惑／征服",
    nameEs: "Seducción / Conquista",
    nameEn: "Seduction / Conquest",
    countertype: false,
    oneLiner: "骄傲表现为一对一的征服：成为某个单一对象所不可缺的。诱惑是攻击，不限于情爱。",
    portrait:
      "纳兰霍将性二号命名为「征服」（conquista），并强调其作为诱惑的本质。此亚型是二号的典范，也是三个亚型中最显性、最具侵略性的诱惑者。骄傲体现在「我能让这个焦点离不开我」——对象可以是一个人，也可以是该亚型要拿下的那件事。主体读取其匮乏并填入自己，给予高度专属感并带有所有权。关系热度下降时，骄傲以责备与纠缠而受伤。一对一的占领。",
    childhood:
      "根据纳兰霍原著及相关观察，性二号常在早期通过诱惑与成为「被欲望的对象」来确保情感安全。家庭动态中若存在情感不稳定或选择性关注，主体学会以强烈的给予、魅力与「为你做任何事」的姿态捕获特定对象的专属欲望。结果是，被选中与被欲望成为骄傲的核心货币，而真正的匮乏与依赖则被持续地否认。",
    neurosis:
      "在性本能领域，神经症状态是对单一对象的操控、不能忍受不被选中、以及付出后的隐性债务。被当成可替换的、普通的，会刺伤骄傲并转为追讨。占有与「我为你／它做了这么多」同属骄傲，对象不限于情人。诱惑是表达情感以引发对象的兴趣、忠诚、保护，却只是表面上的帮助；其深层是「我想要一切」的征服欲，接近「蛇蝎美人」式的危险美丽——需要将对方抓在手中。",
    markers: [
      "一对一里强烈，旨在成为某个单一对象的答案。",
      "需要被这个焦点选中；可替代即骄傲受伤。",
      "给予带有独占与事后追讨，不限于情爱。",
      "诱惑本身成为主要动机，带有侵略性与所有权色彩。",
    ],
    lookalikes: ["4sx", "8sx", "3sx"],
    naranjoKey: "Conquista / seducción of the sexual Two",
  },
  {
    id: "3sp",
    type: 3,
    ...
    portrait:
      "纳兰霍将自我保存三号命名为「安全」（seguridad），并明确标示为反型（contravanidoso）。在此亚型中，虚荣不依赖舞台与表演，而体现为资产、职位、家庭被安排得像样。高效、可靠、形象整洁但不夸张。成功的证据是「我能养活、我有保障」。看起来务实甚至谦逊，因为虚荣已等同于工作本身。自身的存在感被换成产出。",
    childhood:
      "自我保存三号常在早期未获得足够的照顾与资源保障。主体学会自立自强，不依赖他人，甚至反过来照顾父母或解决问题。家庭中的隐含心理遗弃或不足，使「不添麻烦、自己解决、保持可靠」成为生存策略。结果是，安全与自主成为虚荣的核心替代物，感受与依赖被长期搁置。",
    neurosis:
      "在自我保存领域，神经症状态是工作强迫、休息时的恐慌、以及把自我价值等同于供养能力。停下来即面对没有形象的空洞。感受被推迟到「做成以后」，而做成没有以后。羞耻围绕无能、破产、看起来撑不住，而非道德过错。\n\n此亚型因安全受威胁而发展出特殊自主性；自幼学会照顾自己（后来也照顾他人），周围常有安全感氛围，擅长解决问题，却可能因过度追求安全而将生活简化为「实用与有用」。",
    markers: [
      "以工作量、收入和可靠性证明自己。",
      "不空谈名声，但必须「看起来能干」。",
      "停工触发恐慌；休息被体验为堕落。",
      "虚荣隐匿于效率与保障之中，外表常被误认为一号或其他务实类型。",
    ],
  ...
  },
  {
    ...
    portrait:
      "纳兰霍将社交三号命名为「声望」（prestigio）。主体识别群体的成功标准并把自我做成该标准。头衔、奖项、圈子、可见度。纳兰霍指出三号活在「好像」（como si）中；社交三号把「好像成功」做成公开事实。竞争是社会性的。无观众时，他们的自我迅速瘪缩。此亚型是三个三号中最虚荣、最善于变色的，需要所有人的钦佩与掌声。",
    childhood:
      "根据纳兰霍原著及相关观察，社交三号常在早期被要求「展示」某些东西以获得爱与认可。父母的支持多体现为赞许的目光，主体学会通过表演、成就或良好形象来赢得关注。结果是，被看见与被认可成为自体的核心条件，真实感受则被推到次要位置。童年往往以「奖杯」或「表演者」角色存在，为满足家庭对成功与体面的期待。",
    neurosis:
      "在社交领域，神经症状态是自我的不断改妆、对比较的成瘾、以及无人喝彩时的崩溃。人格随受众切换。失败、落后、被看穿「只是表演」会触发羞耻与攻击性防御。诚实的感受被当作对事业的威胁而剔除。社交三号不仅通过工作，更通过呈现方式追求闪耀，需要站在舞台中央，被所有人看见与钦佩。",
    markers: [
      "对名声、比较和公开认可高度敏感。",
      "随场域调整自我呈现。",
      "没有观众的成就几乎不计入自体。",
  ...
  },
  {
    ...
    nameEn: "Attractiveness / Charisma",
    countertype: false,
    oneLiner: "虚荣落在一对一的磁性：成为被选定的那个。失败是失去吸引力，不限于情爱。",
    portrait:
      "纳兰霍将性三号的虚荣命名为「男性气概／女性气质」（masculinidad / feminidad），即一对一场域里的磁性与被选中。形象的核心是「在这个单一焦点面前我是否发光」，不限于性关系，也可以是唯一的观众、对手或事业对象。他们的表演深入身体——姿态、魅力、胜利者的呈现。不被欲求，比道德指责更伤害他们。伊查佐原用「男性气概」或「女性气质」；纳兰霍进一步解释为过度迎合文化（甚至好莱坞式）的性别形象，以吸引异性或焦点对象。",
    childhood:
      "根据纳兰霍原著及相关观察，性三号常在早期学会通过符合性别期待的形象与魅力来获得认可与爱。家庭或环境中对「好看、有吸引力、被选中」的强调，使主体将自体价值与身体吸引力、被欲望的能力绑定。结果是，被确认与被欢迎成为核心需求，真实感受与自主欲望则被压抑，形成高度依赖外部目光的结构。",
    neurosis:
      "在性本能领域，神经症状态是把自体等同于是否在一对一中被选中、是否有竞争力。失败、被无视会体验为存在取消。魅力是被管理的。看起来可像八号或二号，驱动仍是虚荣：我是那个能被需要的人——要的可以是爱、目光或那个位置。此亚型是三个三号中最依赖的，通常不表现攻击性，他们几乎无法容忍拒绝；诱惑旨在被接纳与确认，混淆自我价值与身体吸引力。",
    markers: [
      "在意一对一的吸引力与被选中，不限于情爱。",
      "成就用于增加磁性，多于单纯群体地位。",
      "被当成无能或不可欲，比被道德批评更伤。",
      "表演深入身体与姿态，追求符合性别理想的形象。",
    ],
  ...
  },
  {
    ...
    portrait:
      "纳兰霍将自我保存四号命名为「坚忍」（tenacidad），并标示为反型。他们的痛苦不外露，而转化为某种耐力竞赛：别人轻易得到的，我会用长期的自找苦吃来超过。他们的外表可以是乐天的、像八号。但内里仍是「我没有别人有的那块」，只是他们拒绝乞求。此亚型以「能忍受」为美德，将自我挫败与耐力做成身份。",
    childhood:
      "根据纳兰霍原著及相关观察，自我保存四号常在早期缺乏充分的情感支持（多来自母亲或主要依恋对象），学会不抱怨、不示弱，通过忍耐与努力争取认可。主体往往反过来照顾他人，而非被照顾。结果是，「不诉苦、硬撑、用受苦换取支持」成为生存策略，哀伤被内化并转化为自我要求与纪律。",
    neurosis:
      "在自我保存领域，神经症状态是受虐性的自我剥夺、对「被可怜」的憎恶、以及把吃苦转化为一种优越心理。嫉妒不说「我没有」，而是以「我更能忍受」。抑郁被躯体化或纪律化。因此可能被测成八、一、六。他们的哀伤被禁止公开，却组织着整个生活的气氛。此亚型以抵抗挫折为美德，像劳伦斯（Lawrence of Arabia）用手指熄灭火柴来训练忍痛一样，自幼将耐力当作换取认可的方式。",
    markers: [
      "把吃苦、节俭、硬撑当作优越。",
      "很少当众哀伤；哀伤转为沉默的耐力。",
      "反感被可怜；对「别人更容易」积怨。",
  ...
  },
  {
    ...
    portrait:
      "纳兰霍将社交四号命名为「羞耻」（vergüenza）。他们嫉妒的比较在群体中进行：别人自然拥有着一切，而我总差一截。残缺是他们身份的一种。但在此之中，他们对受难的展示并非单纯的作秀，他们真的生活在「我不够好」之中，又需要这不够好来区别于群众。他们渴求被承认，又想要区别于群体标准。此亚型是「受难者」（sufridor），常表现自身的痛苦、易落泪，并把自己置于受害者的位置。",
    childhood:
      "社交四号常在早期因情感依赖而内化攻击：宁可责备自己，也不敢对所需的母亲（或主要依恋对象）发怒。结果是，主体学会以自我贬低与羞耻维持与重要他人的连接。群体中的比较与「不够好」的感觉成为固定结构，残缺与受伤被用来换取被看见与被特殊对待。",
    neurosis:
      "在社交领域，神经症状态是羞耻、自我放逐、情绪的公开化与对平凡的蔑视。被理解的渴望与「一被理解就普通」的恐惧互相加强。他们的抑郁、被抛弃感、社会比较是日常。身份建立和稳固依赖于受伤，痊愈反而威胁他们自身的特殊性。此亚型往往低估自己，感到自己比他人低劣。",
    markers: [
      "在团体中感到格格不入或被看穿。",
      "身份与残缺、受伤绑在一起。",
      "既要被理解，又怕理解取消其特殊。",
  ...
  },
  {
    ...
    portrait:
      "纳兰霍将性四号命名为「竞争」（competitividad），伊查佐原称「恨」（odio）。对象是一对一的重要焦点：可以是人，也可以是位置和作品——我必须超过你所拥有的，他们的攻击性被强调，也因此，他们是最像八号的四号。如果自己不能占据这个焦点上的第一，就攻击或切断。他们的特殊感通过征服与被征服证明，不限于情爱。",
    childhood:
      "根据纳兰霍原著及相关观察，性四号常在早期与主要依恋对象（多母亲）形成强烈矛盾纽带：对方拥有自己渴望的东西，因此既爱又恨。遗弃或拒绝的体验被内化为「被夺走」的感觉，主体学会以要求、攻击与竞争来夺回。结果是，一对一的较量成为确认存在与价值的主要方式，平淡与第二位不可忍受。",
    neurosis:
      "在性本能领域，神经症状态是一对一中的较量、爱恨速转、对自己身为第二位的不能忍受。把这个单一关系或事业变成戏剧以确认自己还存在。摧毁其所爱（若不能独占其优越位置）是嫉妒的主动形式，而不是八号的过量。此亚型公开表达愤怒，以无耻的态度来对抗羞耻，坚持他们的要求以满足强烈的欲望；其动机更准确说是竞争——也就是具有攻击性的口腔嫉妒，要夺走别人拥有的东西。",
    markers: [
      "一对一中强烈比较，不能被放第二。",
      "投入与攻击迅速互换，对象是单一的人、事或物。",
      "需要张力来维持自体感；平淡不可忍。",
      "最富攻击性的四号，外表可似八号，驱动仍是匮乏与嫉妒。",
    ],
  ...
  },
  {
    ...
    nameEs: "Castillo",
    nameEn: "Castle",
    aka: "避难所／洞穴（Refugio / Cave）",
    countertype: false,
    oneLiner: "贪婪表现为收缩生命：少参与、少依赖、少被看见。外界是消耗。",
    portrait:
      "纳兰霍将自我保存五号命名为「避难所」（refugio），亦常以「城堡」或「洞穴」描述之。贪婪落实为把生命减到可控制的单元：空间、时间、金钱、体力、信息。「怕被吸干」在此具体化。可以节俭到贫乏，也可以在私域富足但不流通。独处说不上是爱好但是一种必然的需要。突然的情感或社交要求被体验为侵入性的行为。此亚型是五号的亚型中最「五号」的，以建立高墙隔绝可入侵的世界为主要策略。",
    childhood:
      "自我保存五号常在早期未获得充分隐私与安全边界。世界被感知为不友好、潜在暴力或侵入性的；主体的私人空间常被打扰，情感表达不被支持。结果是，儿童学会筑起心理与物理的墙，将需求与欲望极度限制，以免依赖或被索取。独处与退缩成为生存的核心策略。",
    neurosis:
      "在自我保存领域，神经症状态是退缩、需求最小化、对人情的记账、以及被接触时的被剥夺感。身体与情绪被当作会漏的容器。孤立维持自给的幻想，同时加深贫乏。给予每一点都伴随悔意与计算。纳兰霍认为此亚型需要退隐，筑起高墙保护内在的小世界；欲望被极度限制，因为每一欲望都可能意味着依赖。",
    markers: [
      "需要可撤退的私域与不被打扰的时间。",
      "对体力、金钱、人情精打细算。",
      "参与之前先观察；支出被体验为流失。",
      "以「小生活」与边界维持安全，外表常显得脆弱或隐匿。",
    ],
  ...
  },
  {
    ...
    portrait:
      "纳兰霍将社交五号命名为「图腾」（tótem）。吝啬转为「我掌握着系统」。他们以专家、理论、“地图的绘制者”在群体中立足，对群体的参与通过观念而非情感接触。给予的是蒸馏过的知识。他们社会性是象征的：一切属于知识共同体，不等于属于他们的社交对象。闲聊与表态使其退回头脑。此亚型往往追求本质与崇高，而非现有之物；图腾既指向建构的高度，也象征被建构的对象而非真人。",
    childhood:
      "社交五号常在早期以知识与理想替代情感连接。世界被感知为需要通过系统与观念来理解与掌控；主体学会仰望「杰出」与「本质」，同时贬低日常与普通人。结果是，归属通过智识角色与知识共同体实现，情感参与被体验为潜在的耗尽而遭到回避。",
    neurosis:
      "在社交领域，神经症状态是用一种智识角色替代人的在场、对无目的交心的不能忍受、以及被当成普通人时的撤退策略。他们可以发言、教学、评论，同时保持情感不流通。优越感与贫乏感并存。此亚型追求一种超级价值，隐含地蔑视普通生活与普通人；只对生命的精华、存在的终极意义感兴趣，却因此对脚下的生活兴趣寥寥，情感贫乏，与真正的精神成就背道而驰。",
    markers: [
      "以专业或「我知道」作为社会身份。",
      "可分享整理过的内容，不交出私生活。",
      "失去智识角色即失去在场理由。",
  ...
  },
  {
    ...
    portrait:
      "纳兰霍将性五号命名为「信赖」（confianza）。他们仍吝啬于世界，却寻求与一个单一焦点彻底交换——可以是一个人，也可以是秘密的工作、研究或私藏。这段关系被理想化、精神化，有时高度投注。信任一旦成立，冷可转为高强度交付。被辜负或通道断裂则长期封闭。驱动仍是：内在不能洒给众人。此亚型是反型，因其在性本能领域寻求绝对信任与融合，与五号典型的全面退缩形成对照。",
    childhood:
      "根据纳兰霍原著及相关观察，性五号常在生命最初几个月即经历纽带创伤：与母亲（或主要依恋对象）的分离、冷漠或攻击性连接，使世界被他们感知为不安全、不可信。主体学会将情感与需求极度内收，却同时渴望一个能完全托付的绝对对象。结果是，对众人保持吝啬与距离，却将全部理想化投注集中于单一焦点，以补偿早期的不信任与匮乏。",
    neurosis:
      "在性本能领域，神经症状态是把一条一对一通道做成唯一出口、理想化与对关系本身突然的彻底切断。对众人贫乏，而对这一个过密。这条通道破裂等于世界的崩塌。对所有人贪婪，一次性透支给一个焦点，此亚型的基本议题是信任——寻找那个无论如何都会与他同在的人，一个远超普通承诺的人；因为追求绝对，因此极易失望。",
    markers: [
      "对「那一个通道」近乎绝对投注：人、事或物。",
      "对众人封闭，对单一焦点可以过密。",
      "通道被辜负后封死，比发作更彻底。",
      "关系被理想化、精神化；信任成立后可高强度交付。",
    ],
