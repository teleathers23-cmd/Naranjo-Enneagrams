  ...
  return (
    <SiteShell>
      ...
      <div className="mt-6 space-y-5 text-sm leading-relaxed text-muted">
        ...
        <p>
          题目全部混排，不按型号分区，以降低猜题、社会赞许和防御。先测九种激情与固着，过程中计算心脑腹三种应对世界方式的重视程度，再进入副型。计分会检查正反向冲突、型号重叠（如骄傲与虚荣）、对峙（如过量与怠惰），以及随机、夸大、中立回避；冲突作答会降权。结果是心–脑–腹三元组，例如 sp3-so6-sp8。每个位置给出强度与核验。完整公式在结果页展开。
        </p>
