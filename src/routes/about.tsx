  ...
  return (
    <SiteShell>
      ...
      <div className="mt-6 space-y-5 text-sm leading-relaxed text-muted">
        ...
        <p>
          结果是心–脑–腹三元组，例如 sp3-so6-sp8。前九题筛三个中心的重视程度；四十五题估九种情欲；第二步在每个中心内取情欲最高的类型，再用副型专名题选出本能变体。三元组的前后顺序等于中心重视的降序，不是流行九型的「主型」。每个位置给出强度（弱 / 中 / 强 / 极强）与核验（通过 / 倾向 / 待核）。完整公式与逐步计算在结果页展开。
        </p>
